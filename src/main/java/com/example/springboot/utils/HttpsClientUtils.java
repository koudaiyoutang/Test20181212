...
public class HttpsClientUtils {
     ...
     * @param params 请求参数集合
     */
    public static HttpClientResult doPostJson(String url, Map<String, String> headers,
            Map<String, String> params) throws Exception {
        System.out.println("*******************************************************");
        // 创建httpClient对象
        CloseableHttpClient httpClient = HttpClients.createDefault();
        ...
        try {
            // 执行请求并获得响应结果
            return getHttpClientResult2(httpResponse, httpClient, httpPost);
        } finally {
            // 释放资源
            release(httpResponse, httpClient);
        }
    ...
    public static void packageParam(Map<String, String> params,
        ...
        if (params != null) {
            ...
            // 设置到请求的http对象中
            String json = (String) JSONArray.toJSON(nvps);
     ...
     * Description: 获得响应结果
     */
    public static HttpClientResult getHttpClientResult2(CloseableHttpResponse httpResponse,
            CloseableHttpClient httpClient, HttpRequestBase httpMethod) throws Exception {
        // 执行请求
        httpResponse = httpClient.execute(httpMethod);
